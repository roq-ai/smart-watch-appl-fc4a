...
import { getWatchById } from 'apiSdk/watches';
import { WatchInterface } from 'interfaces/watch';
import { BluetoothListPage } from 'pages/bluetooths';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('watch', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/watches/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Dial" text={data?.dial} />

                <FormListItem label="Time Setting" text={data?.time_setting} />
