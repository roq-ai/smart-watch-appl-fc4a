...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Smart Watch Application`}</title>

        <meta
          name="description"
          content="Experience the Future of Fitness with Smart Watch Application: Your Personal Health and Time Management Companion, All in the Palm of Your Hand."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the Future of Fitness with Smart Watch Application: Your Personal Health and Time Management Companion, All in the Palm of Your Hand.`}
            </Text>
            <Box
